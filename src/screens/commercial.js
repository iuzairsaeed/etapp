            ...
            <ScrollView style={{flex:1,backgroundColor:'white'}}>
                ...
                <Image source={imgOne} style={{ height: 300, width: widthScreen }} />
                    <View style={{ position: 'absolute', top: 30, left: 30 }}>
                        <Text style={{ color: 'white',fontWeight:'bold', fontSize: 18, }}>COMMERCIAL CARGO</Text>
                        <Text style={{ color: 'white',fontWeight:'bold', fontSize: 24, width: '80%' }}>WE ARE TRANSPOT SERVICE PROVIDER</Text>
                    </View>

                    <CardDetail side={cardSide} head="Commercial Cargo" img={container} txt="Commercial cargo can include anything except Live animal, Human remains and Personal Effects. We transport any kind of freight to any West African country. " onchange={()=>setCardSide(!cardSide)}/>
