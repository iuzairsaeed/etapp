import { View, Text, Button, Image, SafeAreaView, ActivityIndicator, ScrollView, Dimensions, TextInput, TouchableOpacity } from 'react-native';
...
const Contact = ({ navigation }) => {
  ...
  const doContact = () => {
    const { name,
      phone, email, subject, message } = contactData
    setLoading(true)
    if (!name) {
      ...
      fetch(`https://api.codyfied.com/sendcontactemail?name=${name}&phone=${phone}&email=${email}&subject=${subject}&message=${message}`)
        .then(res => {
          res.json().then(data => {
            setLoading(false)
        ...
        <View>
          ...
          <View style={{ width: '90%', marginLeft: '5%' }}>
            ...
            <View style={{ flexDirection: 'row', marginTop: 30 }}>
              ...
              />
              <Text style={{ width: '80%', color: '#ea6618', marginLeft: 10, fontWeight: 'bold', fontSize: 16 }}>143 castle road 517
district, kiyev port south Canada</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', marginTop: 30 }}>
              ...
              />
              <Text style={{ color: '#ea6618', marginLeft: 10, fontWeight: 'bold', fontSize: 16 }}>0780-2323-2322</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', marginTop: 30 }}>
              ...
              />
              <View>
                <Text style={{ color: '#ea6618', marginLeft: 10, fontWeight: 'bold', fontSize: 16 }}>info@yourmail.com</Text>
                <Text style={{ color: '#ea6618', marginLeft: 10, fontWeight: 'bold', fontSize: 16 }}>transpix@yourmail2.com</Text>
                <Text style={{ color: '#ea6618', marginLeft: 10, fontWeight: 'bold', fontSize: 16 }}>ship@yourmail3.com</Text>
              </View>
            ...
            <Text style={{ fontSize: 30, fontWeight: 'bold', textAlign: 'center', marginVertical: 50 }}>For Queries </Text>
            <View style={{ marginBottom: 10 }}>
              <Text style={{ color: 'black', fontSize: 16, marginBottom: 2 }}>Name *</Text>
              <TextInput onChangeText={(e) => setContactData({ ...contactData, name: e })} value={contactData.name} style={{ height: 40, width: '100%', borderWidth: 1, borderColor: 'black' }} />
            </View>
            <View style={{ marginBottom: 10 }}>
            ...
            <View style={{ marginBottom: 10 }}>
              <Text style={{ color: 'black', fontSize: 16, marginBottom: 2 }}>Comment *</Text>
...

            {
              loading ?
                ...
                <TouchableOpacity onPress={() => doContact()} style={{ justifyContent: 'center', height: 50, width: '100%', backgroundColor: '#ea6618' }}>
